...
function checkOverflow(elem) {
  ...
  if (multiple) {
    ...
    return height + padding + border > elemRect.height || elem.scrollHeight > elemRect.height;
  } else {
    ...
    return width + _padding + _border > elemRect.width || elem.scrollWidth > elemRect.width;
  }
}
